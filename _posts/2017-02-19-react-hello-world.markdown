...
맞습니다! 정말 잘 하셨어요. 개인적으로 저는 button과 input역시 모두 Component라고 생각합니다. 그래서 html에 native tag가 있음에도, 항상 Common Component로 만들어두곤 하지요. native tag가 있는데 왜 꼭 Component로 만드는지 의문이 생기실 수도 있는데, 이것에 이점에 대해서는 차차 알아가실 수 있습니다.
